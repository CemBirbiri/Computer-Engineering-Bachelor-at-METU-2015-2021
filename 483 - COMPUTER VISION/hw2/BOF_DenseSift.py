...
def BOF_DenseSIFT():
	...
	i=0
	while(i!=15):
		BOF_DenseSIFT_helper(classes[i])
		i=i+1


def BOF_DenseSIFT_helper(class_name):
	'''
	take images from dataset and find interest points usinf Dense_SIFT
	'''
	...
	for i in range(101,501):
		...
		while(j!=len(des)):
			...
			f=open("BOF_DenseSift_ss3.txt","a+")
			f.write("%s\r\n"  %( des[j].tolist() ))

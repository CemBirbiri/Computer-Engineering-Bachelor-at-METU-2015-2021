...
def find_in_dataset_400(): #400 fotografi original datasetten bulup istenilen  histogramini cikartiyor. --my_best()---fonskiyonunun 
#oldugu yere istedigimiz histogram icin uygun fonk yazip calistiriyoruz
	 
	filepath = '/home/bs05/e2172195/Downloads/hw/test_queries.dat' 
	with open(filepath) as fp:  
	   line = fp.readline()
	   
	   while line:
	       
	       find_in_dataset_400_helper( line.strip())
...
def find_in_dataset_400_helper(strr): #400 fotografi original datasetten bulup grayscale histogramini cikartiyor.

	filepath = '/home/bs05/e2172195/Downloads/hw/dataset/' + strr
	
	img1 = cv2.imread(filepath,1)
	img2= cv2.imread(filepath,0)
	f=open("mybest_100.txt","a+")
	f.write("%s %s\r\n"  %( strr, my_best(img1,img2,10).tolist() ))

...
00000000004011c4 <phase_5>:
  ...
  4011ec:	bb 00 00 00 00       	mov    $0x0,%ebx
  4011f1:	0f be 7c 1d 00       	movsbl 0x0(%rbp,%rbx,1),%edi
  4011f6:	e8 79 03 00 00       	callq  401574 <from_char_to_int>
  4011fb:	83 e0 0f             	and    $0xf,%eax
  4011fe:	0f b6 80 50 28 40 00 	movzbl 0x402850(%rax),%eax
  ...
  401217:	be 06 28 40 00       	mov    $0x402806,%esi
...
0000000000401249 <phase_6>:
  ...
  401292:	44 89 eb             	mov    %r13d,%ebx
  401295:	48 63 c3             	movslq %ebx,%rax
  401298:	8b 04 84             	mov    (%rsp,%rax,4),%eax
  40129b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40129e:	75 05                	jne    4012a5 <phase_6+0x5c>
  4012a0:	e8 58 05 00 00       	callq  4017fd <explode_bomb>
  4012a5:	83 c3 01             	add    $0x1,%ebx
  4012a8:	83 fb 05             	cmp    $0x5,%ebx
  4012ab:	7e e8                	jle    401295 <phase_6+0x4c>
  4012ad:	49 83 c4 04          	add    $0x4,%r12

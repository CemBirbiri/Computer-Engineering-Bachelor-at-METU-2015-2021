...
#these paths are for Google Colab
train_data = np.load ( "/content/hw3/hw3_data/linsep/train_data.npy" )
train_labels = np.load ( "/content/hw3/hw3_data/linsep/train_labels.npy" )

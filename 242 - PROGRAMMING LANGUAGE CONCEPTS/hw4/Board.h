...
public:
	...
	bool is_in(int *x_cord,int* y_cord,uint *ids, int i, int j,int len);
	std::string give_id(int *x_cord,int* y_cord,uint *ids, int i, int j,int len);
	std::string give_ab(int *x_cord,int *y_cord,std::string *abs, int i, int j,int len);
	std::vector<Player*>* get_players();
	std::vector<Player*>* delete_player(Player *player);
	void set_board(std::vector<Player*> *players);
	void print();
};
#endif

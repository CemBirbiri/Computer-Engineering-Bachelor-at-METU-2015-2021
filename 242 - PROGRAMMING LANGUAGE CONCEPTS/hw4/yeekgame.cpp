...
*/
  ...
  bool Game::isGameEnded(){
  	...
  	else if(maxTurnNumber== turnNumber ){
  		std::cout<<"Game ended at turn "<<this->maxTurnNumber-1<<". Maximum turn number reached. Knight victory."<<std::endl;
  		return true;
  	}
  	else{
 ...
 void Game::playTurn(){
  	...
  	for(int i=0; i< players.size(); i++){
  		if(players[i]->getID() == min){ 
  			...
  			//std::cout<<"iiiiii"<<players[i]->getID()<<std::endl;
  	...
  	//std::cout<<"buraya kadar ok3"<<std::endl;
  	if(players.size()==1){
  	...
  	while(j<players.size()){
  		...
  		//std::cout<<"öööööööööööööööööööööööööööö111111----->"<<players.size()<<std::endl;
  		//std::cout<<"ööööööööööööööööööööööööööööö222222----->"<<players[j]->getID()<<std::endl;
